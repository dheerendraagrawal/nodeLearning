...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGhlZXJlbmRyYWFncmF3YWwiLCJhIjoiY2t0anF2bGV1MDBoZjJucGdxdGJkMThiOSJ9.xx00nwW5X3Bni0xKbi9k3A';
...
module.exports = {
  ...
  "_spec": "axios@^0.21.4",
  "_where": "E:\\Node_Learning\\Sec9_10_project_4",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (((_res$data$status = res.data.status) === null || _res$data$status === void 0 ? void 0 : _res$data$status.toLowerCase()) === 'success') {
...
var stripe = Stripe('pk_test_51JZwsUSFPecDGpqLkSuJNZhsQgpDYDT1lf0TojZkUtiItTLvJSkVZM2H4durlAQvM3t1kNLRlap49Fmd1cWKG7xu008LR7EwRu');
